...
export default function Banner(){
    ...
    return (
        <div className={styles.banner} onClick={()=>{setIndex(index+1); alert(index%3)}}>
            ...
            <div className={styles.bannerText}>
                <h1 className='text-5xl font-medium'>Your Travel Partner</h1>
            ...
            <button className='bg-white text-cyan-600 border-cyan-600
                ...
                right-0 hover:bg-cyan-500 hover:text-white hover:border-transparent'
